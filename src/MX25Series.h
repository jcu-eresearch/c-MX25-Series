...
#define MX25Series_SR_SRWD_MASK  (0x1ul << 7ul)  /**< [7..7] Status Register Write Protect */
#define MX25Series_SR_SRWD_SRWD_DISABLE  (0ul << 7ul)  /**< Status Register Write Disable */
#define MX25Series_SR_SRWD_SRWD_ENABLE  (1ul << 7ul)  /**< Status Register Write Enable */
#define MX25Series_SR_QE_POSITION  (6ul)
#define MX25Series_SR_QE_MASK  (0x1ul << 6ul)  /**< [6..6] The Quad Enable (QE) bit, non-volatile bit, while it is "0" (factory default), it performs non-Quad and WP#,
...
#define MX25Series_SR_BP_MASK  (0xFul << 2ul)  /**< [5..2] The Block Protect (BP3, BP2, BP1, BP0) bits, non-volatile bits, indicate the protected area (as
...
#define MX25Series_SR_WEL_MASK  (0x1ul << 1ul)  /**< [1..1] The Write Enable Latch (WEL) bit is a volatile bit that is set to “1” by the WREN instruction. WEL needs to be
...
#define MX25Series_SR_WEL_GET_VALUE(REGISTER) (((REGISTER) & MX25Series_SR_WEL_MASK) >> MX25Series_SR_WEL_POSITION)


#define MX25Series_SR_WIP_POSITION  (0ul)
#define MX25Series_SR_WIP_MASK  (0x1ul << 0ul)  /**< [0..0] The Write in Progress (WIP) bit, a volatile bit, indicates whether the device is busy in program/erase/write
status register progress. When WIP bit sets to 1, which means the device is busy in program/erase/write status
register progress. When WIP bit sets to 0, which means the device is not in progress of program/erase/write status
register cycle. */
#define MX25Series_SR_WIP  (1ul << 0ul)
#define MX25Series_SR_WIP_GET_VALUE(REGISTER) (((REGISTER) & MX25Series_SR_WIP_MASK) >> MX25Series_SR_WIP_POSITION)
...
#define MX25Series_CR_TB_MASK  (0x1ul << 11ul)  /**< [11..11] The Top/Bottom (TB) bit is a non-volatile OTP bit. The Top/Bottom (TB) bit is used to configure the Block Protect
...
#define MX25Series_CR_LH_MASK  (0x1ul << 1ul)  /**< [1..1] The Low Power / High Performance bit is a volatile bit. User can change the value of L/H switch bit to keep Ultra
...
/**
 * MX25Series_read_manufacture_and_device_id issues the REMS command to the chip.
...
/**
 * MX25Series_write_stored_data stores the specified data at the specified address.
 * @param dev the device structure for the MX25Series chip.
...
/**
 * MX25Series_erase erases the specified flash area, specified by erase_type ond memory_address
 * @param dev the device structure for the MX25Series chip.
...
/**
 * MX25Series_get_erasure_size_string converts a MX25Series_Erase_enum_t to a Human Readable String
...
/**
 * MX25Series_get_erasure_max_time returns the appropriate value from the MX25Series_t.chip_def timing section for the provided erase_type.
 * @param dev the device structure for the MX25Series chip.
 * @param erase_type the MX25Series_Erase_enum_t type for which to retrieve the timing value of.
...
/**
 * MX25Series___issue_command write the provided command out on the relevant SPI bus
 * @param dev the device structure for the MX25Series chip.
...
/**
 *  MX25Series___test_linker returns FALSE. A library providing the platform specific implementation functions needs
 *  to provide one for MX25Series___test_linker that returns TRUE. This enables the library to detect if there has
